...
http://pypi.python.org/pypi/plib.stdlib. If you want to use
...
also need to have installed PyYAML, the YAML parsing library
for Python (which in my opinion should be in the Python
standard library).

Note: ``simpleblog`` works with Python 2. If you are using Python
3, see https://github.com/pdonis/simpleblog3.
